...
async function main() {
  ...
  const easygift = Project.create({
    ...
    excerpt: "Discuter d’idées de cadeaux individuel ou collectif, en groupe",
    prof_env: false,
    company_name: null,
    description:
    ...
    area_of_improvement: "Websocket qui fonctionne en prod, design général, SEO, sécurisation renforcé lors de la création de compte et login",

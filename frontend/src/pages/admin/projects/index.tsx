...
export default function Projects() {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        if (formData.getAll('team_members')) {
            formJSON.team_members = formData
                .getAll('team_members')
                .map(id => parseInt(id as string, 10))
        }
        if (formData.getAll('technologies')) {
            formJSON.technologies = formData
                .getAll('technologies')
                .map(id => parseInt(id as string, 10))
        }
                        ...
                        <div className='labels'>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name='duration'
                                    id='duration'
                                    placeholder='6 semaines étalées sur 6 mois'
                                    autoComplete='on'
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder='Design, sécurité, validation'
                                    autoComplete='on'
                                />
                            </div>
                            ...
                            <div className='checkbox'>
                                ...
                                />
                                <label htmlFor='prof_env'>
                                    Réalisé en environnement professionnel
                                </label>
                            </div>

                            <div
                                className={`company ${isProfEnv ? '' : 'hidden'}`}
                            >
                                ...
                                <input
                                    ...
                                    name='company_name'
                                    id='company_name'
                                    placeholder='La French Tech Bordeaux'
                                    autoComplete='on'
                                />
                            </div>
                            ...
                            <div>
                                ...
                                >
                                    {teamMembersData?.teamMembers?.map(
                                        teamMember => (
                                            <option
                                                key={teamMember.id}
                                                value={teamMember.id}
                            ...
                            <div>
                                ...
                                >
                                    {technologiesData?.technologies?.map(
                                        technology => (
                                            <option
                                                key={technology.id}
                                                value={technology.id}

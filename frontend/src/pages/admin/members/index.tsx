import { useCreateTeamMemberMutation, useTeamMembersQuery } from "@/graphql/generated/schema";
import { FormEvent, useEffect, useState } from "react";
import Layout from "@/components/Layout";
import Image from "next/image";

export default function Technologies() {
  const { data: membersData, loading: membersLoading, error: membersError, refetch } = useTeamMembersQuery({});
          ...
          <form onSubmit={handleSubmit} className="form">
            <div className="labels">
              <div>
                ...
                <input required type="text" name="name" id="name" placeholder="Aurélie Lozach" className="" autoComplete="on" />
              </div>
              ...
              <div>
                ...
                <input type="text" name="src_icon" id="src_icon" required placeholder="aurelie.jpeg" className="" autoComplete="on" />
              </div>
